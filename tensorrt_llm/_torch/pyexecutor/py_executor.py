...
class PyExecutor:
    ...
    def _handle_speculative_decoding(self, scheduled_batch, previous_tensors,
        ...
        with request_context(is_draft=self.draft_model_engine is not None,
            ...
            if has_draft_batch:
                draft_outputs, draft_batch = self.drafter.generate_draft_tokens_with_overlap(
                    scheduled_batch, self.resource_manager,
                ...
                self.has_previous_draft_tokens = False
                draft_outputs, draft_batch = None, None
        ...
        return new_target_inputs, draft_outputs, draft_batch
